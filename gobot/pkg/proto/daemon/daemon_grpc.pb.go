...
type DaemonServiceClient interface {
	...
	// CapacityReconcilerCoordinator starts the standing capacity reconciler (st-7zk): drives
	// the contract-delivery machine's actual topology toward the computed desired topology
	...
	// RetireShip withdraws a hull from service: its current tour finishes and sells,
	// and once the hold is empty no coordinator plans it another
	RetireShip(ctx context.Context, in *RetireShipRequest, opts ...grpc.CallOption) (*RetireShipResponse, error)
...
func (c *daemonServiceClient) CapacityReconcilerCoordinator(ctx context.Context, in *CapacityReconcilerCoordinatorRequest, opts ...grpc.CallOption) (*CapacityReconcilerCoordinatorResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *daemonServiceClient) RetireShip(ctx context.Context, in *RetireShipRequest, opts ...grpc.CallOption) (*RetireShipResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RetireShipResponse)
	err := c.cc.Invoke(ctx, DaemonService_RetireShip_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DaemonServiceServer interface {
	...
	// RetireShip withdraws a hull from service: its current tour finishes and sells,
	// and once the hold is empty no coordinator plans it another
	RetireShip(context.Context, *RetireShipRequest) (*RetireShipResponse, error)
	// ListFleets lists every dedicated fleet and its member ships (sp-l7h2)
...
func (UnimplementedDaemonServiceServer) RetireShip(context.Context, *RetireShipRequest) (*RetireShipResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RetireShip not implemented")
}
...
func _DaemonService_CapacityReconcilerCoordinator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CapacityReconcilerCoordinatorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonServiceServer).CapacityReconcilerCoordinator(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonService_CapacityReconcilerCoordinator_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DaemonService_RetireShip_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RetireShipRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonServiceServer).RetireShip(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonService_RetireShip_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonServiceServer).RetireShip(ctx, req.(*RetireShipRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DaemonService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RetireShip",
			Handler:    _DaemonService_RetireShip_Handler,
		},
		{
