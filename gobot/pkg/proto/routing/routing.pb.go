...
//
// fee_credits is the MEAN of that gate's observed jumps, not a single reading: 71% of
// traffic crosses gates whose fee varies under 5% about their own mean, but 4.7% crosses
// three gates that vary by more than 15%. A non-positive fee is IGNORED by the solver
// (that crossing falls back to the flat charge); it is never charged as free.
type GateFee struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
const file_pkg_proto_routing_routing_proto_rawDesc = "" +
	"\n" +
	"\x1fpkg/proto/routing/routing.proto\x12\arouting\"\x8c\x01\n" +
	"\bWaypoint\x12\x16\n" +
	...
	"\x13ROUTE_ACTION_REFUEL\x10\x022\xeb\x02\n" +
...
var file_pkg_proto_routing_routing_proto_goTypes = []any{
	...
	(*RouteStep)(nil),                  // 2: routing.RouteStep
	(*OptimizeTourRequest)(nil),        // 3: routing.OptimizeTourRequest
	(*OptimizeTourResponse)(nil),       // 4: routing.OptimizeTourResponse
	(*OptimizeFueledTourRequest)(nil),  // 5: routing.OptimizeFueledTourRequest
	(*OptimizeFueledTourResponse)(nil), // 6: routing.OptimizeFueledTourResponse
	(*TourLeg)(nil),                    // 7: routing.TourLeg
	(*IntermediateStop)(nil),           // 8: routing.IntermediateStop
	(*PartitionFleetRequest)(nil),      // 9: routing.PartitionFleetRequest
	(*ShipConfig)(nil),                 // 10: routing.ShipConfig
	(*PartitionFleetResponse)(nil),     // 11: routing.PartitionFleetResponse
	(*ShipTour)(nil),                   // 12: routing.ShipTour
	(*MarketGoodSnapshot)(nil),         // 13: routing.MarketGoodSnapshot
	(*TourShip)(nil),                   // 14: routing.TourShip
	(*TourCargoItem)(nil),              // 15: routing.TourCargoItem
	(*TourConstraints)(nil),            // 16: routing.TourConstraints
	(*GateFee)(nil),                    // 17: routing.GateFee
	(*InterSystemHopDistance)(nil),     // 18: routing.InterSystemHopDistance
...
var file_pkg_proto_routing_routing_proto_depIdxs = []int32{
	0,  // 0: routing.RouteStep.action:type_name -> routing.RouteAction
	1,  // 1: routing.OptimizeTourRequest.all_waypoints:type_name -> routing.Waypoint
	2,  // 2: routing.OptimizeTourResponse.route_steps:type_name -> routing.RouteStep
	1,  // 3: routing.OptimizeFueledTourRequest.all_waypoints:type_name -> routing.Waypoint
	7,  // 4: routing.OptimizeFueledTourResponse.legs:type_name -> routing.TourLeg
	8,  // 5: routing.TourLeg.intermediate_stops:type_name -> routing.IntermediateStop
	28, // 6: routing.PartitionFleetRequest.ship_configs:type_name -> routing.PartitionFleetRequest.ShipConfigsEntry
	1,  // 7: routing.PartitionFleetRequest.all_waypoints:type_name -> routing.Waypoint
	29, // 8: routing.PartitionFleetResponse.assignments:type_name -> routing.PartitionFleetResponse.AssignmentsEntry
	2,  // 9: routing.ShipTour.route_steps:type_name -> routing.RouteStep
	15, // 10: routing.TourShip.cargo:type_name -> routing.TourCargoItem
	18, // 11: routing.TourConstraints.inter_system_hops:type_name -> routing.InterSystemHopDistance
	17, // 12: routing.TourConstraints.gate_fees:type_name -> routing.GateFee
	19, // 13: routing.TradeTourLeg.trades:type_name -> routing.TourTrade
	13, // 14: routing.OptimizeTradeTourRequest.snapshot:type_name -> routing.MarketGoodSnapshot
	14, // 15: routing.OptimizeTradeTourRequest.ship:type_name -> routing.TourShip
	16, // 16: routing.OptimizeTradeTourRequest.constraints:type_name -> routing.TourConstraints
	...
	10, // 23: routing.PartitionFleetRequest.ShipConfigsEntry.value:type_name -> routing.ShipConfig
	12, // 24: routing.PartitionFleetResponse.AssignmentsEntry.value:type_name -> routing.ShipTour
	3,  // 25: routing.RoutingService.OptimizeTour:input_type -> routing.OptimizeTourRequest
	5,  // 26: routing.RoutingService.OptimizeFueledTour:input_type -> routing.OptimizeFueledTourRequest
	9,  // 27: routing.RoutingService.PartitionFleet:input_type -> routing.PartitionFleetRequest
	26, // 28: routing.RoutingService.OptimizeTradeTour:input_type -> routing.OptimizeTradeTourRequest
	4,  // 29: routing.RoutingService.OptimizeTour:output_type -> routing.OptimizeTourResponse
	6,  // 30: routing.RoutingService.OptimizeFueledTour:output_type -> routing.OptimizeFueledTourResponse
	11, // 31: routing.RoutingService.PartitionFleet:output_type -> routing.PartitionFleetResponse
	27, // 32: routing.RoutingService.OptimizeTradeTour:output_type -> routing.OptimizeTradeTourResponse
...
func file_pkg_proto_routing_routing_proto_init() {
	...
	file_pkg_proto_routing_routing_proto_msgTypes[0].OneofWrappers = []any{}
	...
	file_pkg_proto_routing_routing_proto_msgTypes[4].OneofWrappers = []any{}
	...
	file_pkg_proto_routing_routing_proto_msgTypes[10].OneofWrappers = []any{}
	type x struct{}
