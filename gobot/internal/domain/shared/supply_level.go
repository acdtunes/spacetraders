...
// validSupplyValues is the STRICT set of accepted supply-level strings. It is
// distinct from ParseSupplyLevel, which is intentionally lenient (it defaults any
