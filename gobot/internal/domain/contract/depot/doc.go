// Package depot models the "contract depot" — a first-class, fully
...
//
// Acceptance invariant: instantiating a depot at a different waypoint, or with
...
// AT the destination depot can deliver locally (~0 haul) while the stocker
