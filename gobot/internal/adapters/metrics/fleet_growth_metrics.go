...
func (c *FleetGrowthMetricsCollector) RecordLaneSurface(playerID string, s LaneSurface) {
	...
	c.laneSurface.WithLabelValues(playerID, "trade_hold_capacity").Set(float64(s.TradeHoldCapacity))
	c.laneSurface.WithLabelValues(playerID, "saturation_threshold").Set(float64(s.SaturationThreshold))
