...
// expansion coordinator's optional ports: the live-treasury reader and the
// probe price-and-buy port over the existing purchase_ship machinery. The coordinator's
// decision logic lives in internal/application/expansion/commands; these adapters are the
// seams the daemon wires it to at composition time (main.go).
package expansion
