...
// '1' < '2' lexicographically), which reads as a scrambled fleet roster and
// was part of the naming-order blindness behind the sp-lybx incident (two
// PROBEs pinned into the contract fleet at purchase went unnoticed). Natural
// order compares embedded digit runs numerically instead, so ships list in
// the order a human expects: TORWIND-2, TORWIND-3, ..., TORWIND-10.
