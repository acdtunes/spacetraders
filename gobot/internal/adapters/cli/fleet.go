...
type fleetMutator interface {
	AssignShipFleet(ctx context.Context, shipSymbol, fleet string, playerIdent *PlayerIdentifier) (*pb.AssignShipFleetResponse, error)
	UnassignShipFleet(ctx context.Context, shipSymbol string, playerIdent *PlayerIdentifier) (*pb.UnassignShipFleetResponse, error)
	ListFleets(ctx context.Context, playerIdent *PlayerIdentifier) (*pb.ListFleetsResponse, error)
}
...
func runFleetAdd(ctx context.Context, client fleetMutator, operation, shipSymbol string, playerIdent *PlayerIdentifier) (string, error) {
	resp, err := client.AssignShipFleet(ctx, shipSymbol, operation, playerIdent)
	if err != nil {
...
func runFleetRemove(ctx context.Context, client fleetMutator, operation, shipSymbol string, playerIdent *PlayerIdentifier) (string, error) {
	resp, err := client.ListFleets(ctx, playerIdent)
	if err != nil {
	...
	if _, err := client.UnassignShipFleet(ctx, shipSymbol, playerIdent); err != nil {
...
Examples:
  ...
  spacetraders fleet add --operation trade --ship TORWIND-9 --agent TORWIND`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg, err := runFleetAdd(ctx, client, operation, shipSymbol, playerIdent)
			if err != nil {
				return err
			}
			fmt.Print(msg)
...
Examples:
  ...
  spacetraders fleet remove --operation trade --ship TORWIND-9 --agent TORWIND`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg, err := runFleetRemove(ctx, client, operation, shipSymbol, playerIdent)
			if err != nil {
				return err
			}
			fmt.Print(msg)
...
Examples:
  ...
  spacetraders fleet assign --ship TORWIND-7 --fleet contract --agent TORWIND`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			response, err := client.AssignShipFleet(ctx, shipSymbol, fleet, playerIdent)
			if err != nil {
...
Examples:
  ...
  spacetraders fleet unassign --ship TORWIND-7 --agent TORWIND`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			response, err := client.UnassignShipFleet(ctx, shipSymbol, playerIdent)
			if err != nil {
...
Examples:
  ...
  spacetraders fleet list --agent TORWIND`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			response, err := client.ListFleets(ctx, playerIdent)
			if err != nil {
