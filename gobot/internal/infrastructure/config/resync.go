...
// periodic full-fleet ship resync falls back to when the operator has
...
// ResyncConfig holds the periodic full-fleet ship-resync knobs under
// the [ship_resync] section. Following the live-config idiom, a zero
