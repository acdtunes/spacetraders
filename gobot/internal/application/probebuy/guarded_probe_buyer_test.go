...
func TestBuys_WhenDemandExceedsSupplyAndGuardsPass(t *testing.T) {
	...
	out := b.MaybeBuy(context.Background(), shared.MustNewPlayerID(1), 5 /*demand*/, 3 /*supply*/, false)
...
func TestNoBuy_WhenSupplyCoversDemand(t *testing.T) {
	...
	out := b.MaybeBuy(context.Background(), shared.MustNewPlayerID(1), 3 /*demand*/, 3 /*supply*/, false)
...
func TestNoBuy_WhenAGuardFails(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			out := b.MaybeBuy(context.Background(), shared.MustNewPlayerID(1), 10 /*demand*/, tc.supply, false)
...
func TestDryRun_EvaluatesButDoesNotBuy(t *testing.T) {
	...
	out := b.MaybeBuy(context.Background(), shared.MustNewPlayerID(1), 5, 0, true /*dryRun*/)
