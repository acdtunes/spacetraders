...
// be filled: a suppression loop.
//
// Reached through the trait pass rather than through a mistake: staging deliberately
// still stages at never-priced yards (that is how the fleet learns), the queue scans
// one, and the memo records a probe-less answer.
