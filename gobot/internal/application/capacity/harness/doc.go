// Package harness is the st-6wa DB-seeded verification harness for the capacity
// reconciler (epic st-7zk). It is verification-FIRST: the harness itself is the
// deliverable.
//
...
//
// The Governor is the one component NOT driven from main: st-x00's real capex
...
// variant used to prove the CONVERGE capital backstop is structural. Once
// st-x00 lands, the real governor drops in behind the same seam.
//
