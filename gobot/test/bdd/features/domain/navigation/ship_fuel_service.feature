Feature: Ship Fuel Service
  ...
  Scenario: Check if ship cannot navigate with insufficient fuel
    ...
    When I check if ship with 10 units of fuel can navigate from "X1-A1" to "X1-B2"
