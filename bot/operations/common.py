...
from .captain_logging import CaptainLogWriter
...
def get_api_client(player_id: int, db_path: str = "data/spacetraders.db"):
    """
...
def get_captain_logger(player_id: int, db_path: str = "data/spacetraders.db") -> Optional[CaptainLogWriter]:
