...
Task(
  ...
  prompt="You are the Market Analyst. Analyze cached market data for system X1-HU87, highlight top spreads, freshness, and risks. See agents/market-analyst.md for full instructions.",
  subagent_type="general-purpose"
)

Task(
  description="Plan trade route for SHIP-1",
  prompt="You are the Trade Strategist. Using the latest market intel, propose the best trading plan for SHIP-1 in system X1-HU87. Include projected profit, stops, and risks. See agents/trade-strategist.md.",
  subagent_type="general-purpose"
)

Task(
  description="Launch SHIP-1 trading daemon",
  prompt="You are the Trading Operator. Launch the approved plan for SHIP-1: buy at X1-HU87-D42, sell at X1-HU87-A2, duration 2 hours, min profit 150000. Ensure assignments stay in sync. See agents/trading-operator.md.",
  subagent_type="general-purpose"
)
```
...
- `agents/templates/*.md` - Specialist agent instructions
