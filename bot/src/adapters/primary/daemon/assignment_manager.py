"""Ship assignment manager to prevent double-booking"""
import logging
...
class ShipAssignmentManager:
    ...
    def assign(
        ...
        Args:
            ...
            operation: Operation type (e.g., 'mining', 'trading')
    ...
    def get_assignment_info(
        ...
        This is a public API method that allows tests and other code to query
        assignment status without direct SQL access.
        ...
        Returns:
            Dict with status, container_id, release_reason, etc. or None if not found
        """
    ...
    def release_all_active_assignments(self, reason: str = "daemon_restart"):
        """Release all active ship assignments

        This is called on daemon startup to clean up zombie assignments
        from previous daemon instances that crashed or were killed.
