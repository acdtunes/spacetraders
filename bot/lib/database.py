...
class Database:
    ...
    def __init__(self, db_path: str = "data/spacetraders.db"):
        """
...
def get_database(db_path: str = "data/spacetraders.db") -> Database:
    ...
    if normalized_path not in _db_instances:
        _db_instances[normalized_path] = Database(db_path)
