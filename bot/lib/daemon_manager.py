...
class DaemonManager:
    ...
    Usage:
        ...
        daemon.start("mine_SHIP1", ["python3", "spacetraders_bot.py", "mine", "--ship", "SHIP-1"])
    ...
    def __init__(self, player_id: int, daemon_dir: str = "operations/daemons", db_path: str = "data/spacetraders.db"):
        """
        ...
        self.logs_dir = self.daemon_dir / "logs"
