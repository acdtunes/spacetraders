...
class SmartNavigator:
    ...
    def __init__(self, api_client, system: str, cache_dir: str = 'graphs', graph: Optional[Dict] = None, db_path: str = "data/spacetraders.db"):
        """
    ...
    def validate_route(self, ship_data: Dict, destination: str) -> Tuple[bool, str]:
        ...
        from routing import FuelCalculator
        current_location = ship_data['nav']['waypointSymbol']
