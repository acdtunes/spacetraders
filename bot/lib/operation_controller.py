...
class OperationController:
    ...
    def __init__(self, operation_id: str, state_dir: str = "operations/state"):
        """
...
def send_control_command(operation_id: str, command: str, state_dir: str = "operations/state"):
    """
    ...
    """
    state_file = Path(state_dir) / f"{operation_id}.json"
...
def list_operations(state_dir: str = "operations/state") -> list:
    """
    List all operations
