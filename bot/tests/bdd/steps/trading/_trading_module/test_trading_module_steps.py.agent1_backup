"""
BDD Step Definitions for _trading module components

Tests for market_service, circuit_breaker, trade_executor, dependency_analyzer, and route_executor
"""
...
# Load all feature files in this directory
