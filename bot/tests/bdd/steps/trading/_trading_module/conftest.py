...
def mock_api(mock_api_client):
    """Alias for mock_api_client (for backward compatibility with extracted steps)"""
...
def mock_ship(mock_ship_controller):
    """Alias for mock_ship_controller (for backward compatibility with extracted steps)"""
...
# ============================================================================
# SHARED STEP DEFINITIONS (extracted from bloated files)
# ============================================================================
