...
from spacetraders.adapters.primary.daemon.command_container import CommandContainer
from spacetraders.adapters.primary.daemon.assignment_manager import ShipAssignmentManager
from spacetraders.adapters.primary.daemon.types import ContainerStatus
...
def create_navigation_container(context, ship_symbol):
    ...
    from spacetraders.configuration.container import get_database, get_mediator
