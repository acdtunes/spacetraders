...
from spacetraders.domain.navigation.route import (
    Route,
    RouteSegment,
    RouteStatus
)
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Create route segment with required fields")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Create route segment with refuel flag")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Route segment is immutable")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Route segment repr shows segment info")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Route segment repr includes refuel marker when needed")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Create route with valid data")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Cannot create route with disconnected segments")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Cannot create route when segment exceeds fuel capacity")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Allow segment at capacity limit")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Route ID is readonly")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Ship symbol is readonly")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Player ID is readonly")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Segments returns copy to prevent mutation")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Status is readonly")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Current segment index is readonly")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Route starts in planned status")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Start execution transitions to executing")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Cannot start execution when already executing")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Cannot start execution when completed")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Complete segment advances index")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Complete segment multiple times")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Complete segment transitions to completed when done")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Cannot complete segment when not executing")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Fail route transitions to failed")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Abort route transitions to aborted")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Calculate total distance")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Calculate total fuel required")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Calculate total travel time")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Calculations with single segment")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Get first segment initially")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Get next segment after completion")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Returns None when route completed")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Returns all segments initially")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Returns remaining after completion")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Returns empty list when completed")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Returns zero initially")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Returns updated index after completion")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Returns segment count when completed")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Repr contains route info")
...
# ==============================================================================
@scenario("../../features/domain/route_entity.feature", "Repr updates with status")
