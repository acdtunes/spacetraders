...
from spacetraders.application.navigation.commands.navigate_ship import NavigateShipCommand, NavigateShipHandler
from spacetraders.domain.shared.ship import Ship, InvalidNavStatusError
...
def database_ship_status(context, ship_symbol, status):
    ...
    from spacetraders.configuration.container import get_ship_repository
...
async def _send_navigation_command_async(context, ship_symbol):
    ...
    from spacetraders.configuration.container import get_ship_repository, get_routing_engine
...
def database_ship_fuel(context, ship_symbol, fuel):
    ...
    from spacetraders.configuration.container import get_ship_repository
    from spacetraders.domain.shared.value_objects import Fuel
