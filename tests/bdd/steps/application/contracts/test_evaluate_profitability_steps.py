...
from spacetraders.application.contracts.queries.evaluate_profitability import (
...
def evaluate_profitability(context):
    ...
    def mock_find_cheapest(query):
        ...
        if market_data is None:
            return None
        from spacetraders.application.trading.queries.find_cheapest_market import CheapestMarketResult
