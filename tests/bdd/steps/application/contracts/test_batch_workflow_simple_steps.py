...
from spacetraders.application.contracts.commands.batch_contract_workflow import (
    BatchContractWorkflowCommand,
    BatchContractWorkflowHandler,
    BatchResult
)
from spacetraders.domain.shared.contract import Contract, ContractTerms, Delivery, Payment
...
def execute_batch_workflow(context, iterations):
    ...
    from spacetraders.application.contracts.queries.evaluate_profitability import ProfitabilityResult
    ...
    def mock_send(cmd):
        from spacetraders.application.contracts.commands.negotiate_contract import NegotiateContractCommand
        from spacetraders.application.contracts.queries.evaluate_profitability import EvaluateContractProfitabilityQuery
        from spacetraders.application.contracts.queries.get_active_contracts import GetActiveContractsQuery
        from spacetraders.application.contracts.commands.accept_contract import AcceptContractCommand
        from spacetraders.application.trading.commands.purchase_cargo import PurchaseCargoCommand
        from spacetraders.application.contracts.commands.deliver_contract import DeliverContractCommand
        from spacetraders.application.contracts.commands.fulfill_contract import FulfillContractCommand
