...
from spacetraders.ports.outbound.api_client import ISpaceTradersAPI
...
class MockShipRepository(IShipRepository):
    ...
    def sync_from_api(self, ship_symbol: str, player_id: int, api_client, graph_provider) -> Ship:
        ...
        """
        from spacetraders.application.navigation.commands._ship_converter import convert_api_ship_to_entity
