...
from spacetraders.application.shipyard.commands.purchase_ship import (
    PurchaseShipCommand,
    PurchaseShipHandler
)
...
from spacetraders.domain.shared.exceptions import ShipNotFoundError, InsufficientCreditsError, ShipyardNotFoundError, NoShipyardFoundError
import requests
...
def purchase_ship(context, handler, ship_type, ship_symbol, shipyard_waypoint, player_id):
    ...
    async def execute_purchase():
        ...
        with patch('spacetraders.configuration.container.get_mediator') as mock_get_mediator, \
            ...
            from spacetraders.application.navigation.commands.navigate_ship import NavigateShipCommand
            from spacetraders.application.shipyard.queries.get_shipyard_listings import GetShipyardListingsQuery
...
def system_has_waypoints(context, system_symbol, datatable):
    ...
    from spacetraders.configuration.container import get_waypoint_repository
    ...
    async def execute_purchase():
        ...
        with patch('spacetraders.configuration.container.get_mediator') as mock_get_mediator, \
            ...
            def mediator_send_side_effect(request):
                ...
                from spacetraders.application.shipyard.commands.sync_waypoints import SyncSystemWaypointsCommand
                from spacetraders.configuration.container import get_waypoint_repository
