...
from spacetraders.application.shipyard.commands.batch_purchase_ships import (
...
from spacetraders.domain.shared.exceptions import ShipNotFoundError, InsufficientCreditsError
    ...
    async def execute_batch_purchase():
        with patch('spacetraders.configuration.container.get_mediator') as mock_get_mediator, \
            ...
            def mediator_send_side_effect(request):
                ...
                from spacetraders.application.shipyard.commands.purchase_ship import PurchaseShipCommand
