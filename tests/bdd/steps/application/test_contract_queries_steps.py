...
from spacetraders.application.contracts.queries.get_contract import GetContractQuery
from spacetraders.application.contracts.queries.list_contracts import ListContractsQuery
...
def mediator(context):
    ...
    from spacetraders.configuration.container import _db, get_mediator
